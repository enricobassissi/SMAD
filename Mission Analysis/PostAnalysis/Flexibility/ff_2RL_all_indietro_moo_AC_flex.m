function obj_fun = ff_2RL_all_indietro_moo_AC_flex(x, data, sim)
%{ 
...
if data.IDX_WhichSpacecraftWeAreChanging == 1
    % 1st sc ast change
    IDP_temp = x(10); % index for 2nd permutation matrix to be built inside depending on the first 2 selected asteroids
