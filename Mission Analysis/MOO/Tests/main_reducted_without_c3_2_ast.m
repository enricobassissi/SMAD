...
sim.moo_bound.lb = [sim.moo_lim.mjd2000_ed, sim.moo_lim.TOF1_min]; % Lower bound
sim.moo_bound.ub = [sim.moo_lim.mjd2000_ld, sim.moo_lim.TOF1_max]; % Upper bound
...
options.MaxStallGenerations = 2;

%% Build the moo
FitnessFunction = @ff_neo_without_c3_2_ast; % Function handle to the fitness function
