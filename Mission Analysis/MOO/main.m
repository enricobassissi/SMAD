...
sim.moo_lim.TOF1_max = 2*365; % days
...
sim.moo_lim.TOF2_max = 2*365; % days
...
options.MaxStallGenerations = 5;

%% Build the moo
FitnessFunction = @ff_neo; % Function handle to the fitness function
