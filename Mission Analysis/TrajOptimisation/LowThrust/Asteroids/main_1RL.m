...
sim.max_Available_Thrust = 0.01; % 10 mN, BepiColombo was 250 mN but was much bigger
...
xline(output.tEnd.Leg41,'LineWidth',2);
% xlabel('Time [days]')
...
hello_orbit1 = sol.departure_mjd2000 + output.tEnd.Leg11;
hello_orbit2 = sol.departure_mjd2000 + output.tEnd.Leg21;
hello_orbit3 = sol.departure_mjd2000 + output.tEnd.Leg31;
