function [output, r_encounter, v_encounter, sol] = plot_ff_2RL_all_indietro_GA_ball_DSM(x,sim,data,sol)
%{ 
...
% SC1
sol.Mass_at_start_SC1 = Mass_at_start_SC1;
sol.mass_depleted_DSM1 = sol.Mass_at_start_SC1 - output_1.m(1);
...
sol.mass_fract_SC1 = sol.tot_mass_depleted_SC1/sol.Mass_at_start_SC1;
...
% SC2
sol.Mass_at_start_SC2 = Mass_at_start_SC2;
sol.mass_depleted_DSM2 = sol.Mass_at_start_SC2 - output_a.m(1);
...
sol.mass_fract_SC2 = sol.tot_mass_depleted_SC2/sol.Mass_at_start_SC2;
...
sol.obj_fun(1) = 20*(dV_DSM_GA + dV_DSM2_GA) + penalty_dV_C3 + 100*dV_diff_wrt_C3_SC1 + ...
    pen_dV_DSM + pen_dV_DSM2 + penalty_dv_GA1 + penalty_dv_GAa + ...
    MF + penalty_MAX_DURATION + penalty_MF_unfeasible;

sol.obj_fun(2) = 30*(penalty_T_leg1 + penalty_T_leg2 + penalty_T_lega + penalty_T_legb) + ...
