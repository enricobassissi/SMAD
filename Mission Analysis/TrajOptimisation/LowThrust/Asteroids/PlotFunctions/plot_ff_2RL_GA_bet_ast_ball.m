function [output, r_encounter, v_encounter, sol] = plot_ff_2RL_GA_bet_ast_ball(x,sim,data,sol,power_propulsion_data)
%{ 
...
sol.dV_D1_GA = dV_D1_GA*(sim.DU/sim.TU)*1e3;
...
sol.dV_Da_GA = dV_Da_GA*(sim.DU/sim.TU)*1e3;
...
sol.mass_depleted_GA1_inj = Mass_before_burn_to_GA1 - Mass_GA1_leg;
...
sol.LT_mass_depleted_SC1 = sol.mass_depleted_Leg1+sol.mass_depleted_Leg2;
% sol.mass_dry_and_pods_SC1 = output_1.m(1) - sol.tot_mass_depleted_SC1;
sol.mass_fract_SC1 = sol.LT_mass_depleted_SC1/output_1.m(1); % fuel/wet
...
sol.mass_depleted_GAa_inj = Mass_before_burn_to_GAa - Mass_GAa_leg;
...
sol.LT_mass_depleted_SC2 = sol.mass_depleted_Lega+sol.mass_depleted_Legb;
% sol.mass_dry_and_pods_SC2 = output_a.m(1) - sol.tot_mass_depleted_SC2;
sol.mass_fract_SC2 = sol.LT_mass_depleted_SC2/output_a.m(1);
