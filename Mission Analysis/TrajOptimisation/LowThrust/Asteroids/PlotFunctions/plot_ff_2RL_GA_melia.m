function [output, r_encounter, v_encounter, sol] = plot_ff_2RL_GA_melia(x,sim,data,sol,power_propulsion_data)
%{ 
...
output.t_SC1            = [output_1.t; t_span_CT1'; t_span_CT1(end)+output_GA1.t; t_span_CT1(end)+output_GA1.t(end)+output_2.t];
output.t_SC2            = [output_a.t; t_span_CTa'; t_span_CTa(end)+output_GAa.t; t_span_CTa(end)+output_GAa.t(end)+output_b.t];
output.m_SC1            = [output_1.m; mCT1; output_GA1.m; output_2.m];
output.m_SC2            = [output_a.m; mCTa; output_GAa.m; output_b.m];
output.Thrust_SC1       = [output_1.Thrust; TCT1; output_GA1.Thrust; output_2.Thrust];
output.T_magn_SC1       = sqrt(output.Thrust_SC1(:,1).^2 + output.Thrust_SC1(:,3).^2);
output.Thrust_SC2       = [output_a.Thrust; TCTa; output_GAa.Thrust; output_b.Thrust];
output.T_magn_SC2       = sqrt(output.Thrust_SC2(:,1).^2 + output.Thrust_SC2(:,3).^2);
output.a_SC1            = [output_1.a; output_GA1.a; output_2.a];
output.a_SC2            = [output_a.a; output_GAa.a; output_b.a];
output.r.leg1       = output_1.r; 
output.r.legGA1     = output_GA1.r;
output.r.leg2       = output_2.r;
output.r.lega       = output_a.r;
output.r.legGAa     = output_GAa.r;
output.r.legb       = output_b.r;
output.theta.leg1   = output_1.theta; 
output.theta.legGA1 = output_GA1.theta; 
output.theta.leg2   = output_2.theta;
output.theta.lega   = output_a.theta;
output.theta.legGAa = output_GAa.theta; 
output.theta.legb   = output_b.theta;
output.z.leg1       = output_1.z;
output.z.legGA1     = output_GA1.z;
output.z.leg2       = output_2.z;
output.z.lega       = output_a.z;
output.z.legGAa     = output_GAa.z;
output.z.legb       = output_b.z;
output.Href.leg1    = output_1.Href;
output.Href.legGA1  = output_GA1.Href;
output.Href.leg2    = output_2.Href;
output.Href.lega    = output_a.Href;
output.Href.legGAa  = output_GAa.Href;
output.Href.legb    = output_b.Href;

output.t1           = output_1.t;
output.CT1          = t_span_CT1';
output.t_GA1        = output_GA1.t;
output.t2           = output_2.t;
output.ta           = output_a.t;
output.CTa          = t_span_CTa';
output.t_GAa        = output_GAa.t;
output.tb           = output_b.t;

%% --
sol.T_1 = output_1.Thrust;
sol.T_GA1 = output_GA1.Thrust;
sol.T_2 = output_2.Thrust;
sol.T_a = output_a.Thrust;
sol.T_GAa = output_GAa.Thrust;
