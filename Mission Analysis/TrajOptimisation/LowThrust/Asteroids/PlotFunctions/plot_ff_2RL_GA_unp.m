function [output, r_encounter, v_encounter, sol] = plot_ff_2RL_GA_unp(x,sim,data,sol,power_propulsion_data)
...
% sol.diff_C3 = abs(dV_EA_DSM2 - dV_EA_DSM)*sim.DU/sim.TU;
