...
sim.M_pods = 3; % mass of the payloads + landing stuff [kg] %%
sim.max_Available_Thrust = 0.02; % 20 [mN], BepiColombo is 250 mN but it's much bigger
...
%% Build the soo
FitnessFunction = @(x) ff_2RL_Tav(x,sim,data,power_propulsion_data); % Function handle to the fitness function
