...
bound.TOF_P1_max = 1/6*365*3600*24/sim.TU; % days
...
bound.TOF_P2_max = 1/6*365*3600*24/sim.TU;
...
bound.TOF_DSM_max = 1/6*365*3600*24/sim.TU;
...
bound.TOF_P4_max = 1/6*365*3600*24/sim.TU;
...
bound.lb = [bound.rP1_min,bound.thetaP1_min,bound.TOF_P1_min,bound.rP2_min,bound.thetaP2_min,...
            ...
            bound.IDP2_min,bound.mjd2000_ed];
bound.ub = [bound.rP1_max,bound.thetaP1_max,bound.TOF_P1_max,bound.rP2_max,bound.thetaP2_max,...
            ...
            bound.IDP2_max,bound.mjd2000_ld];
...
FitnessFunction = @(x) ff_2RL_GA_ball_simplified_JP(x,sim,data); % Function handle to the fitness function
...
sol.N_revb = x(23);
% mission duration
% sol.mission_duration_d_SC2 = sol.TOF_DSM2+sol.TOFGA_a+sol.TOFa+sol.CT1+sol.TOFb;
% sol.mission_duration_y_SC2 = sol.mission_duration_d_SC2/365;
% sol.arrival_dat = mjd20002date(sim.departure_adim*sim.TU/(3600*24)+sol.mission_duration_d_SC2);
% asteorids
sol.IDP2 = x(24);
sol.asteroid_a = data.PermutationMatrix(sol.IDP2,1);
sol.asteroid_b = data.PermutationMatrix(sol.IDP2,2);
% sol.asteroid_a = "2010UJ";
% sol.asteroid_b = "2016CK137";

%% characteristic quantities plot
[output, r_encounter, v_encounter, sol] = plot_ff_2RL_GA_ball_simplified_JP(x,sim,data,sol);
