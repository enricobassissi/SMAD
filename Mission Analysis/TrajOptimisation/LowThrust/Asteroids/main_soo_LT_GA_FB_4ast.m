...
%      v_inf_magn2,azimuth2,elevation2,azimuth3,elevation3,NREVGA]
...
bound.lb = [bound.mjd2000_ed, bound.TOF1_min, bound.TOF2_min, ...
    ...
    bound.el3_min, bound.N_REV_GA_min]; % Lower bound
bound.ub = [bound.mjd2000_ld, bound.TOF1_max, bound.TOF2_max, ...
    ...
    bound.el3_max, bound.N_REV_GA_max]; % Upper bound
...
%% Build the soo
FitnessFunction = @(x) ff_ea_4ast_LT_GA_FB_soo_NLI(x,sim,data); % Function handle to the fitness function
...
[output, r_encounter, v_encounter, sol] = plot_ff_ea_4ast_LT_GA_FB_soo_NLI(x,sim,data,sol);
