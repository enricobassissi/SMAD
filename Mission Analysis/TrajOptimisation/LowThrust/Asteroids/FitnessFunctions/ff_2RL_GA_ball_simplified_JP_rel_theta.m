function obj_fun = ff_2RL_GA_ball_simplified_JP_rel_theta(x,sim,data)
%{ 
...
% SC2
mass_depleted_EA_P1 = sim.M1 - M_start_P1_P2_leg;
...
mass_fract_SC2 = tot_mass_depleted_SC2/sim.M1;
