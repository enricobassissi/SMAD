function obj_fun = ff_2RL_GA_ball_anna(x,sim,data,power_propulsion_data)
%{ 
...
% TOF2 (14)
% N REV 2 (15)
% TOF_DSM2, from earth dep to DSM time -> determined by thetaD2
% thetaD (16)
% TOFGA (17)
% vinf (GRAVITY ASSIST) (18)
% azimuth in (PRE-GRAVITY ASSIST) (19)
% elevation (PRE-GRAVITY ASSIST) (20)
...
IDP1 = x(28); %index of permutation, the column of the Permutation Matrix of the asteroids
...
[rDSM2, vDSM2] = sv_from_coe(coe_DSM2,ksun); % input: km, rad; output; km, km/s
rDSM2 = rDSM2/sim.DU;
...
mass_fract_SC1 = tot_mass_depleted_SC1/sim.M1;
...
obj_fun = MF + penalty_MAX_DURATION + penalty_MF_unfeasible + ...
    ...
    pen_dV_DSM + pen_dV_DSM2 + penalty_dsm_hyp;
