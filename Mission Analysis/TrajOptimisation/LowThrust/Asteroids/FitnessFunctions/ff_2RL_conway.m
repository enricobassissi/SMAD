function obj_fun = ff_2RL_conway(x,sim,data)
%{ 
...
% SC1 
% 1st leg - Earth -> Ast 1
[output_1] = CW_LowLambert_of( r_EA , rA1 , v_dep , vA1 , N_rev1 , TOF1 ,sim.M1 ,0 , 0 , sim.PS ,sim );
...
[output_2] = CW_LowLambert_of( rD1 , rA2 , vD1 , vA2 , N_rev2 , TOF2 ,M_start_2nd_leg,0 , 0 , sim.PS ,sim );
...
% SC 2
[output_a] = CW_LowLambert_of( r_EA , rAa , v_dep , vAa , N_reva, TOFa ,sim.M2,0 , 0 , sim.PS ,sim );
...
[output_b] = CW_LowLambert_of( rDa , rAb , vDa , vAb , N_revb, TOFb ,M_start_b_th_leg,0 , 0 , sim.PS ,sim );
