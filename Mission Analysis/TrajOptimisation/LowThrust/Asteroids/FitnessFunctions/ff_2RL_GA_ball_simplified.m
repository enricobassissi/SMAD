function obj_fun = ff_2RL_GA_ball_simplified(x,sim,data,power_propulsion_data)
%{ 
...
% IDP1 = x(13); %index of permutation, the column of the Permutation Matrix of the asteroids
...
obj_fun = MF + penalty_MAX_DURATION + penalty_MF_unfeasible + ...
    20*dV_DSM_GA + penalty_dV_C3 + penalty_dv_GA1 + ...
    20*(penalty_T_leg1 + penalty_T_leg2) + ...
    penalty_TOF_leg1 + penalty_TOF_leg2 + pen_dV_DSM;
