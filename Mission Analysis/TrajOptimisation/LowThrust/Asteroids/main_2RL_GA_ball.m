...
sim.M1 = 140; % SC wet mass [kg] %%
sim.M2 = 140; % SC wet mass [kg] %%
...
bound.TOF_DSM1_max = 0.7*365*3600*24/sim.TU; % days
% rD (3)
...
bound.TOF_DSM2_max = 0.7*365*3600*24/sim.TU; % days
% rD2 (14)
bound.rD2_min = 0.8; % AU, +/- 20%
bound.rD2_max = 1.2; % AU
% thetaD2 (15)
...
% TOFGA (16)
bound.TOFGA_2_min = 0.1*365*3600*24/sim.TU; %10*3600
...
bound.ub = [bound.mjd2000_ed,bound.TOF_DSM1_max,bound.rD1_max,bound.thetaD1_max,bound.TOFGA_1_max,...
...
% (9) NREV1, (12) NREV2, (20) NREVa, (23) N REV b, (24) IDP, (25) IDP2
constr.IntCon = [9,12,20,23,24,25];
...
%% Build the soo
FitnessFunction = @(x) ff_2RL_GA_ball_DSM(x,sim,data); % Function handle to the fitness function
