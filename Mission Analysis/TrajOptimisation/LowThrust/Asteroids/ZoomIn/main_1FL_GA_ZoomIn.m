...
load('ws_1FL_EAGA_0.75_pods_44mN.mat')
% load('ws_1FL_MAGA_0.66_pods_52mN.mat')
...
% (6) NREV1, (7) NREV2, (8) NREV3, (9) NREV4, (19) NREVGA
constr.IntCon = [6,7,8,9,19];
...
%% Build the soo
FitnessFunction = @(x) ff_1FL_GA_ZoomIn(x,sim,data,best); % Function handle to the fitness function
...
sol.asteroid_1 = best.asteroid_1;
sol.asteroid_2 = best.asteroid_2;
sol.asteroid_3 = best.asteroid_3;
sol.asteroid_4 = best.asteroid_4;
...
sol.TOF3_ADIM  = x(4);
sol.TOF4_ADIM  = x(5);
sol.TOFGA = x(13)*sim.TU/(3600*24);
sol.TOF1 = x(2)*sim.TU/(3600*24);
sol.TOF2 = x(3)*sim.TU/(3600*24);
sol.TOF3 = x(4)*sim.TU/(3600*24);
sol.TOF4 = x(5)*sim.TU/(3600*24);
...
sol.objfun = Fval;
sol.Nrev = [x(19), x(6), x(7), x(8), x(9)];
sol.v_inf_magn = x(10)*sim.DU/sim.TU;
sol.az = x(11);
sol.el = x(12);

sol.v_inf_magn2 = x(14)*sim.DU/sim.TU;
sol.v_inf_ast1_magn = x(20)*sim.DU/sim.TU;
sol.v_inf_ast2_magn = x(23)*sim.DU/sim.TU;
sol.v_inf_ast3_magn = x(26)*sim.DU/sim.TU;
sol.v_inf_ast4_magn = x(29)*sim.DU/sim.TU;

%% characteristic quantities plot
[output, r_encounter, sol] = plot_ff_1FL_GA_ZoomIn(x,sim,data,sol,best);
