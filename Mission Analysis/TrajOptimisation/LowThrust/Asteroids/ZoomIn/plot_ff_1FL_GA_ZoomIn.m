function [output, r_encounter, sol] = plot_ff_1FL_GA_ZoomIn(x,sim,data, sol,best)
...
% asteroid1 flyby
v_inf_ast1_magn = x(20);
az_ast1 = x(21);
el_ast1 = x(22);
% asteroid2 flyby
v_inf_ast2_magn = x(23);
az_ast2 = x(24);
el_ast2 = x(25);
% asteroid3 flyby
v_inf_ast3_magn = x(26);
az_ast3 = x(27);
el_ast3 = x(28);
% asteroid4 flyby
v_inf_ast4_magn = x(29);
az_ast4 = x(30);
el_ast4 = x(31);
...
% 3rd leg - Ast1 -> Ast2
M_start_2nd_leg = output_1.m(end)- sim.M_pods; %  - sim.M_pods;
