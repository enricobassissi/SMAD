...
sim.max_Available_Thrust = 0.01; % 10 [mN], BepiColombo is 250 mN but it's much bigger
...
% TOFa (4)
bound.TOFa_min = 0*365*3600*24/sim.TU; %600
...
bound.TOFGA_1_max = 2*365*3600*24/sim.TU; 
% N REV GA (18)
bound.N_REVGA_1_min = 0; %0
bound.N_REVGA_1_max = 1; %3
% vinf (GRAVITY ASSIST) (19)
bound.v_inf_GA_1_magn_min = 0;
bound.v_inf_GA_1_magn_max = 5/sim.DU*sim.TU; % relative velocity at encounter with earth for GA
% azimuth in (PRE-GRAVITY ASSIST) (20)
bound.az_in_GA_1_min = -pi;
bound.az_in_GA_1_max =  pi;
% elevation (PRE-GRAVITY ASSIST) (21)
bound.el_in_GA_1_min = -pi/2;
bound.el_in_GA_1_max =  pi/2;
...
bound.TOFGA_2_max = 2*365*3600*24/sim.TU; 
% N REV GA (25)
bound.N_REVGA_2_min = 0; %0
bound.N_REVGA_2_max = 1; %3
% vinf (GRAVITY ASSIST) (26)
bound.v_inf_GA_2_magn_min = 0;
bound.v_inf_GA_2_magn_max = 5/sim.DU*sim.TU; % relative velocity at encounter with earth for GA
% azimuth in (PRE-GRAVITY ASSIST) (27)
bound.az_in_GA_2_min = -pi;
bound.az_in_GA_2_max =  pi;
% elevation (PRE-GRAVITY ASSIST) (28)
bound.el_in_GA_2_min = -pi/2;
bound.el_in_GA_2_max =  pi/2;
...
%      CT1,CTa,(TOFGA,N REV GA,vinf,azimuth in,elevation,azimuth out,elevation)x2]
bound.lb = [bound.mjd2000_ed, bound.TOF1_min, bound.TOF2_min, ...
    ...
    bound.TOFGA_1_min, bound.N_REVGA_1_min, bound.v_inf_GA_1_magn_min, ...
    bound.az_in_GA_1_min, bound.el_in_GA_1_min, bound.az_out_GA_1_min, bound.el_out_GA_1_min, ...
    bound.TOFGA_2_min, bound.N_REVGA_2_min, bound.v_inf_GA_2_magn_min, ...
    bound.az_in_GA_2_min, bound.el_in_GA_2_min, bound.az_out_GA_2_min, bound.el_out_GA_2_min]; % Lower bound
bound.ub = [bound.mjd2000_ld, bound.TOF1_max, bound.TOF2_max, ...
    ...
    bound.TOFGA_1_max, bound.N_REVGA_1_max, bound.v_inf_GA_1_magn_max, ...
    bound.az_in_GA_1_max, bound.el_in_GA_1_max, bound.az_out_GA_1_max, bound.el_out_GA_1_max, ...
    bound.TOFGA_2_max, bound.N_REVGA_2_max, bound.v_inf_GA_2_magn_max, ...
    bound.az_in_GA_2_max, bound.el_in_GA_2_max, bound.az_out_GA_2_max, bound.el_out_GA_2_max]; % Upper bound
...
%% Build the soo
FitnessFunction = @(x) ff_2RL_GA_melia(x,sim,data,power_propulsion_data); % Function handle to the fitness function
...
sol.TOFGA1 = x(17)*sim.TU/86400;
sol.TOF2 = x(3)*sim.TU/86400;
sol.TOFa = x(4)*sim.TU/86400;
sol.TOFGAa = x(24)*sim.TU/86400;
sol.TOFb = x(5)*sim.TU/86400;
sol.TOF1_ADIM = x(2);
sol.TOFGA1_ADIM = x(17);
sol.TOF2_ADIM = x(3);
sol.TOFa_ADIM = x(4);
sol.TOFGAa_ADIM = x(24);
sol.TOFb_ADIM = x(5);
sol.CT1 = x(15)*sim.TU/86400;
sol.CTa = x(16)*sim.TU/86400;
sol.CT1_ADIM = x(15);
sol.CTa_ADIM = x(16);
sol.mission_duration_d_SC1 = sol.TOF1+sol.CT1+sol.TOFGA1+sol.TOF2;
sol.mission_duration_d_SC2 = sol.TOFa+sol.CTa+sol.TOFGAa+sol.TOFb;
...
sol.Nrev = [x(6), x(7), x(8), x(9), x(18), x(25)];
...
[sol_dates] = sol_to_dates_of_mission_LT(sol,'2RL_GA_in_between_asteroids')

%% characteristic quantities plot
[output, r_encounter, v_encounter, sol] = plot_ff_2RL_GA_melia(x,sim,data,sol,power_propulsion_data);
% Thrust
