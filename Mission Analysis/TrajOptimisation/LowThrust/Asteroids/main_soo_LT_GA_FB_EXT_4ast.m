...
% TOFGA (14)
bound.TOFGA_min = 400*3600*24/sim.TU; 
bound.TOFGA_max = 2.5*365*3600*24/sim.TU; 
% TOF1 (2)
bound.TOF1_min = 0.5*365*3600*24/sim.TU; 
bound.TOF1_max = 2.5*365*3600*24/sim.TU; 
% TOF2 (3)
bound.TOF2_min = 0.5*365*3600*24/sim.TU; 
bound.TOF2_max = 2.5*365*3600*24/sim.TU; 
% TOF3 (4)
bound.TOF3_min = 0.5*365*3600*24/sim.TU; 
bound.TOF3_max = 2.5*365*3600*24/sim.TU; 
% TOF4 (5)
...
bound.lb = [bound.mjd2000_ed, bound.TOF1_min, bound.TOF2_min, ...
    ...
    bound.az_ast2_in_min, bound.el_ast2_in_min, bound.az_ast2_out_min, bound.el_ast2_out_min, ...
    bound.az_ast3_in_min, bound.el_ast3_in_min, bound.az_ast3_out_min, bound.el_ast3_out_min, ...
    bound.az_ast4_in_min, bound.el_ast4_in_min]; % Lower bound
bound.ub = [bound.mjd2000_ld, bound.TOF1_max, bound.TOF2_max, ...
    ...
    bound.az_ast2_in_max, bound.el_ast2_in_max, bound.az_ast2_out_max, bound.el_ast2_out_max, ...
    bound.az_ast3_in_max, bound.el_ast3_in_max, bound.az_ast3_out_max, bound.el_ast3_out_max, ...
    bound.az_ast4_in_max, bound.el_ast4_in_max]; % Upper bound
...
%% Build the soo
FitnessFunction = @(x) ff_ea_4ast_LT_GA_FB_EXT_soo_NLI(x,sim,data); % Function handle to the fitness function
...
[output, r_encounter, v_encounter, sol] = plot_ff_ea_4ast_LT_GA_FB_EXT_soo_NLI(x,sim,data,sol);
